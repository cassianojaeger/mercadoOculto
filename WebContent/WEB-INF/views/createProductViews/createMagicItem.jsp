...
<body>
	...
	<form:form class="form-horizontal" modelAttribute="magicItems"
		servletRelativeAction="/create-products/magicItem?${_csrf.parameterName}=${_csrf.token}" 
		method="POST"
		enctype="multipart/form-data">
		<fieldset style="width: 50%; margin: 0 auto">
			<label><h1>Registro de itens mágicos</h1></label>
			...
			<div class="control-group">
				<!-- price -->
				<label class="control-label" for="stockQuantity">Quantidade em estoque</label>
				<div class="controls">
					<form:input path="stockQuantity" placeholder="Stock Quantity..." class="form-control" type="number" />
					<form:errors class="error" path="stockQuantity" />
					<br>
				</div>
			</div>
